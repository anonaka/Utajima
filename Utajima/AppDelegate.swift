...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    override init(){
        super.init()
        self.nc.addObserver(self, selector: #selector(AppDelegate.rounteChangeEventHandler(_:)),
            name: NSNotification.Name.AVAudioSessionRouteChange,
            object: nil)
    }
    
    func rounteChangeEventHandler(_ notification: Notification){
        ...
        if let reason: NSNumber = notification.userInfo![AVAudioSessionRouteChangeReasonKey] as! NSNumber?{
            if let r = AVAudioSessionRouteChangeReason(rawValue: UInt(reason.intValue)) {
                switch r {
                case .newDeviceAvailable:
                    print("New device available")
                case .oldDeviceUnavailable:
                    print("Old device unavaiable")
                    self.model.stop()
                default:
                    print("Other reason:\(r)")
                }
            } else {
                print ("Other reason")
            }
    ...
    func applicationDidEnterBackground(_ application: UIApplication) {
        self.model.saveMusicCollection()
    }
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "UtajimaSongModel", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.appendingPathComponent("Utajima.sqlite")
